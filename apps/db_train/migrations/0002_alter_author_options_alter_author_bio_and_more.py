# Generated by Django 4.2.5 on 2024-04-29 21:14
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='author',
            name='first_name',
            field=models.CharField(blank=True, help_text='Ограничение - не более 100 символов', max_length=50, null=True, verbose_name='Имя'),
        ),
        migrations.AlterField(
            model_name='author',
            name='gender',
        ...
        migrations.AlterField(
            model_name='author',
            name='phone_number',
            field=models.CharField(blank=True, help_text="Введите номер телефона через '+7' без пробелов в формате +79123456789 ", max_length=12, null=True, unique=True, validators=[django.core.validators.RegexValidator(message='Телефон должен быть формата: +79123456789', regex='^\\+79\\d{9}$')], verbose_name='Номер телефона'),
        ),
        migrations.AlterField(
            model_name='author',
            name='self_esteem',
